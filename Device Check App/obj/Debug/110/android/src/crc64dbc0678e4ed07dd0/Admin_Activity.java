...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Device_Check_App.Admin_Activity, Device Check App", Admin_Activity.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == Admin_Activity.class)
			mono.android.TypeManager.Activate ("Device_Check_App.Admin_Activity, Device Check App", "", this, new java.lang.Object[] {  });
	}
